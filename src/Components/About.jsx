                                    ...
                                    <div className="about-list">
                                        <ul>
                                            <li>
                                                ...
                                                <p>From fashion to electronics and furniture, we bring everything.</p>
                                            </li>
                                            <li>
                                                <span>
                                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                ...
                                                <p>All product is handpicked to ensure comfort, and customer satisfaction.</p>
                                            </li>
                                            <li>
                                                <span>
                                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                ...
                                                <p>Premium products at budget-friendly rates for every shopper.</p>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <p>Fast delivery, easy returns, and dedicated support.</p>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <p>Apni Dukan aims to be your go-to destination for reliable online shopping</p>
                                            </li>
                                        </ul>
                                    </div>
