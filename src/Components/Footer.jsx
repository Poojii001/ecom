                  ...
                  <div className="service-img">
                    <span>
                      <svg width="32" height="37" viewBox="0 0 36 37" fill="none"
                        ...
                        <path d="M1 1H5.63636V24.1818H35" stroke="#F9FFFB" strokeWidth="2"
                        ...
                        <path
                          ...
                          stroke="#F9FFFB" strokeWidth="2" strokeMiterlimit="10"
                        ...
                        <path
                          ...
                          stroke="#F9FFFB" strokeWidth="2" strokeMiterlimit="10"
                          strokeLinecap="square" />
                        <path d="M34.9982 1H11.8164V18H34.9982V1Z" stroke="#F9FFFB" strokeWidth="2"
                          strokeMiterlimit="10" strokeLinecap="square" />
                        <path d="M11.8164 7.17969H34.9982" stroke="#F9FFFB" strokeWidth="2"
                          strokeMiterlimit="10" strokeLinecap="square" />
                      </svg>
                    ...
                    <span>
                      <svg width="32" height="37" viewBox="0 0 32 34" fill="none"
                        ...
                        <path
                          ...
                          stroke="#F9FFFB" strokeWidth="2" strokeMiterlimit="10" />
                        <path d="M30.7 2L29.5 10.85L20.5 9.65" stroke="#F9FFFB" strokeWidth="2"
                          strokeMiterlimit="10" strokeLinecap="square" />
                      </svg>
                    </span>
                  </div>
                  ...
                  <div className="service-img">
                    <span>
                      <svg width="32" height="37" viewBox="0 0 32 35" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 13H5.5C2.95 13 1 11.05 1 8.5V1H7" stroke="#F9FFFB" strokeWidth="2"
                          strokeMiterlimit="10" />
