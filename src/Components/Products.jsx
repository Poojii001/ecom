            ...
            <div className="section-title">
                ...
                <div className="countdown-section">
                    <div className="countdown-items">
                        <span id="day" className="number text-danger" >0</span>
                        <span className="text">Days</span>
                    </div>
                    <div className="countdown-items">
                        <span id="hour" className="number text-primary">0</span>
                        <span className="text">Hours</span>
                    </div>
                    <div className="countdown-items">
                        <span id="minute" className="number text-success">0</span>
                        <span className="text">Minutes</span>
                    </div>
                    <div className="countdown-items">
                        <span id="second" className="number text-secondary">0</span>
                        <span className="text">seconds</span>
                    </div>
                </div>
                <a href="flash-sale.html" className="view">View All</a>
            </div>
