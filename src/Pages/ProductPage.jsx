                        ...
                        <div className="product-info-content" data-aos="fade-left">
                            ...
                            <div className="product-size">
                                ...
                                <div className="size-section">
                                    ...
                                    <div className="toggle-btn">
                                        <span className="toggle-btn2"></span>
                            ...
                            <div className="product-report">
                                ...
                                <div className="modal-wrapper action">
                                    <div onClick="modalAction('.action')" className="anywhere-away"></div>
                                    ...
                                    <div className="login-section account-section modal-main">
                                        <div className="review-form">
                                            ...
                                            <div className="review-form-name address-form">
                                                <label for="reporttitle" className="form-label">Enter Report Ttile*</label>
                                                <input type="text" id="reporttitle" className="form-control"
                                                    placeholder="Reports Headline here"/>
                                            </div>
                                            <div className="review-form-name address-form">
                                                <label for="reportnote" className="form-label">Enter Report Note*</label>
                                                <textarea name="ticketmassage" id="reportnote" cols="40" rows="3"
                                                    className="form-control" placeholder="Type Here"></textarea>
                                            </div>
            ...
            <div className="product-detail-section">
                <nav>
                    <div className="nav nav-tabs nav-item" id="nav-tab" role="tablist">
                        ...
                        <button className="nav-link" id="nav-seller-tab" data-bs-toggle="tab" data-bs-target="#nav-seller"
